                ...
                <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 mb-6">
                    <form className="space-y-4">
                        ...
                        <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
                            ...
                            <Link to="/sign-in"
                                  className="text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out">Sign
                                in instead</Link>
                        </div>
                        <button type="submit"
                                className="w-full bg-blue-600 text-white px-7 py-3 rounded text-sm font-medium uppercase shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-200 ease-in-out active:bg-blue-800">Send
                            reset password
                        </button>
                        <div
